...
You are on the test framework branch
-----

Tests rely on [Doctest Framework](https://github.com/doctest/doctest).

All required Cmake variables are set up, and the test framework is used as a submodule;
