...
#ifndef SANDBOX_PLUGIN_COMMON_PLUGINEDITOR_H_
#define SANDBOX_PLUGIN_COMMON_PLUGINEDITOR_H_
...
class SandBoxAudioProcessorEditor : public juce::AudioProcessorEditor,
                                    public juce::ChangeBroadcaster,
                                    public juce::ChangeListener,
                                    public juce::Timer {
 public:
  explicit SandBoxAudioProcessorEditor(SandBoxAudioProcessor* owner);
  ~SandBoxAudioProcessorEditor();
  ...
  SandBoxAudioProcessor* getProcessor() const;
...
#endif  // SANDBOX_PLUGIN_COMMON_PLUGINEDITOR_H_
